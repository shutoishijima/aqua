    ...
    @endcomponent
        ...
        <div class="contents-page">
            ...
            @foreach ($sales as $sale)
                @if ($sale->content_lock == '0')
                    <div class="content-for">
                        <div class="content-name">
                            <p>{{ $total }}、{{ $sale->content_name }}</p>
                        </div>

                        <div class="content-video center">
                            <video src={{ asset($sale->content_path) }} controls></video>
                        </div>

                        <div class="content-detail">
                            <p>{{ $sale->content_detail }}</p>
                        </div>
                    </div>
                ...
                @else
                    <div class="content-for">
                        ...
                        <div class="content-video center">
                            <img src={{ asset($sale->content_img_path) }} alt="営業力講義" />
                        </div>
